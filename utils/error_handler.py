"""Error handling utilities for the PowerSymphony workflow system."""
...
async def handle_mac_exception(request: Request, exc: MACException) -> JSONResponse:
    """Handle PowerSymphony exceptions and return standardized error response."""
    logger = get_server_logger()
    
    # Log the error
    logger.log_exception(
        exc,
        f"PowerSymphony exception occurred: {exc.error_code} - {exc.message}",
